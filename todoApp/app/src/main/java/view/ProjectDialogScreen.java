...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    // criando uma controller para gerenciar os registros no banco de dados
    ...
    private void initComponents() {
        ...
        jPanelToolBarLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelToolBarTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try {
            if (!jTextFieldName.getText().equals("")) {
                ...
                project.setName(jTextFieldName.getText()); // pegando o texto q o usuario digitou dentro do componente
                project.setDescription(jTextAreaDescription.getText()); // pegando a descrição digitada pelo usuario
            
                controller.save(project);
            
                JOptionPane.showMessageDialog(rootPane, "Projeto salvo com sucesso!");
            
                this.dispose(); // fechar janela ao salvar
            } else {
                JOptionPane.showMessageDialog(rootPane, "Nome do projeto não informado!");
